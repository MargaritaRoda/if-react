          ...
          <div className="top-section__body">
            ...
            <form action="/" className="top-section__form">
              ...
              <div className="top-section__form-row top-section__form-row--calendar top-section__form-row--calendar--in">
                <label
                  htmlFor="calendar-in"
                  className="top-section__form-label"
                >
                  Check-in
                </label>
                ...
                <div className="form-panel form-panel--hidden adults-form">
                  <div className="adults-form__row">
                    ...
                    <div className="adults-form__row-right">
                      <button
                        disabled
                        className="adults-form__btn adults-btn--minus"
                      >
                        -
                      </button>
                      <div className="adults-form__number-adults">0</div>
                      <button className="adults-form__btn adults-btn--plus">
                        +
                      </button>
                    </div>
                  </div>
                  <div className="adults-form__row">
                    ...
                    <div className="adults-form__row-right">
                      <button
                        disabled
                        className="adults-form__btn children-btn--minus"
                      >
                        -
                      </button>
                      <div className="adults-form__number-children">0</div>
                      <button className="adults-form__btn children-btn--plus">
                        +
                      </button>
                    </div>
                  </div>
                  <div className="adults-form__row">
                    ...
                    <div className="adults-form__row-right">
                      <button
                        disabled
                        className="adults-form__btn rooms-btn--minus"
                      >
                        -
                      </button>
                      <div className="adults-form__number-rooms">0</div>
                      <button className="adults-form__btn rooms-btn--plus">
                        +
                      </button>
                    </div>
                  </div>
              ...
              <div className="top-section__form-row top-section__form-row--btn">
                <div className="top-section__btn-wrapper">
                  <button className="top-section__submit-btn" type="button">
                    Search
                  </button>
                </div>
              </div>
      ...
      <section className="homes" hidden id="js-available_hotels">
        <div className="container homes__container">
          ...
          <div className="homes__slider">
            <div className="homes__items"></div>
            <div className="homes__slider-next">
